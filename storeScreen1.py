...
class StoreScreen(Screen):
    def __init__(self, robot, game):
        ...
        start = BuildButton("tobuildscreen", pygame.Rect(scrright-200, scrbottom-100, 200, 100), "back_button_big.png", BuildButton.clicked, self)
        buy = BuyButton("buythings", pygame.Rect(500, scrbottom-140, 400,150), "buy_button.png", BuyButton.clicked, self)
